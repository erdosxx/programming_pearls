#ifndef ALGORITHM_ANALYSIS_ALL_PAIRS_SHORTEST_PATH_H
#define ALGORITHM_ANALYSIS_ALL_PAIRS_SHORTEST_PATH_H
...
#endif //ALGORITHM_ANALYSIS_ALL_PAIRS_SHORTEST_PATH_H
