#ifndef ALGORITHM_ANALYSIS_BINOMIALQUEUE_H
#define ALGORITHM_ANALYSIS_BINOMIALQUEUE_H
...
public:
    ...
    void deleteMin( Comparable & minItem ) {
        ...
        // Construct H'' See Fig. 6.48 p293
        BinomialQueue deletedQueue;
        deletedQueue.theTrees.resize( minIndex );

        // 1 << minIndex = 2^minIndex
        // Binomial tree at minIndex contains 2^minIndex nodes
        // So reduce size 1 by removing root node.
        ...
        // Construct H' See Fig. 6.47 p293
        theTrees[ minIndex ] = nullptr;

        // currentSize + 1 = Binomial tree node size at minIndex
...
#endif //ALGORITHM_ANALYSIS_BINOMIALQUEUE_H
