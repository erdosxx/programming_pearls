#ifndef ALGORITHM_ANALYSIS_SPLAYTREE_H_H
#define ALGORITHM_ANALYSIS_SPLAYTREE_H_H
...
// TODO: Support large nodes without stack error.
    ...
    void splay( const Comparable & x, BinaryNode * & t ) {
        ...
        for( ; ; )
            if( x < t->element ) {
                ...
                rightTreeMin->left = t;
                //rightTreeMin = t;
                // Update righhtTreeMin and t for next loop
                ...
                leftTreeMax->right = t;
                //leftTreeMax = t;
                // Update leftTreeMax and t for next loop
...
#endif //ALGORITHM_ANALYSIS_SPLAYTREE_H_H
