#ifndef ALGORITHM_ANALYSIS_TREAP_H
#define ALGORITHM_ANALYSIS_TREAP_H
        ...
        if( t != nullNode ) {
            if( x < t->element )
                ...
                if( t != nullNode )      // Continue on down
                    remove( x, t );
                else { // After rotateWithRightChild rotation, t is nullNode and the left child,
                    // which now stores the item to be deleted.
                    delete t->left;
...
#endif //ALGORITHM_ANALYSIS_TREAP_H
