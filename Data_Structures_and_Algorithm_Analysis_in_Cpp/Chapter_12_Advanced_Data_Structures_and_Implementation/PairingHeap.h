#ifndef ALGORITHM_ANALYSIS_PAIRINGHEAP_H
#define ALGORITHM_ANALYSIS_PAIRINGHEAP_H

#include "../include/dsexceptions.h"
#include <iostream>
#include <stdexcept>
#include "Vector.h"
using namespace std;
...
public:
    ...
    void decreaseKey( Position p, const Comparable & newVal ) {
        ...
        if( p != root ) {
            ...
            //---------  TODO: extract method for this code block
...
private:
     ...
     */
    // TODO: current size limit is about 40000. Need to extend this limit.
...
#endif //ALGORITHM_ANALYSIS_PAIRINGHEAP_H
