#ifndef ALGORITHM_ANALYSIS_PERMUTATION_ARRAY2_H
#define ALGORITHM_ANALYSIS_PERMUTATION_ARRAY2_H
...
// @include
    ...
    void CyclicPermutation(int start, vector<int>* perm_ptr,
                           vector<int>* A_ptr) {
        vector<int>& perm = *perm_ptr;
        vector<int>& A = *A_ptr;
        int i = start;
...
#endif //ALGORITHM_ANALYSIS_PERMUTATION_ARRAY2_H
