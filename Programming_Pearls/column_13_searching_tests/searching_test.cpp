...
TEST_F(SearchingFixture, IntSetArr_Function) {
    Integer_Set_Sorted_Array atest = Integer_Set_Sorted_Array(size_ary, 100000);
    atest.insert(10);
    atest.insert(20);
    atest.insert(20);
    atest.insert(30);
...
TEST_F(SearchingFixture, IntSetList_Function) {
    Integer_Set_Sorted_List atest = Integer_Set_Sorted_List(size_ary, 100000);
...
TEST_F(SearchingFixture, IntSetList2_Function) {
    Integer_Set_Sorted_list_with_allocator atest = Integer_Set_Sorted_list_with_allocator(size_ary, 100000);
    atest.insert(10);
    ASSERT_EQ(1, atest.size());
    atest.insert(20);
    ASSERT_EQ(2, atest.size());
...
TEST_F(SearchingFixture, IntSetBins_Function) {
    Integer_Set_with_Hash_Bins atest = Integer_Set_with_Hash_Bins(size_ary, 100000);
    atest.insert(10);
    ASSERT_EQ(1, atest.size());
    atest.insert(20);
    ASSERT_EQ(2, atest.size());
...
TEST_F(SearchingFixture, IntSetBins2_Function) {
    Integer_Set_with_Hash_Bins_with_allocator atest = Integer_Set_with_Hash_Bins_with_allocator(size_ary, 100000);
    atest.insert_recursive(10);
    ASSERT_EQ(1, atest.size());
    atest.insert_non_recursive(20);
    ASSERT_EQ(2, atest.size());
